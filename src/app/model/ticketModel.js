...
class ticketModel {
  ...
  async getVeById(idVe) {
    return new Promise((resolve, reject) => {
      const querryVe = `SELECT p.*, l.ngayChieu, l.caChieu, l.giaPhim, t.tenPhongChieu, v.*, g.tenGhe,
      (l.giaPhim * v.soVe) AS tongTienVe, (v.tongTien - (l.giaPhim * v.soVe)) AS tongTienDoAn
        FROM ve v 
